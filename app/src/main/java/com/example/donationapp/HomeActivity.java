    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Intent intent=new Intent(HomeActivity.this,DonateCategoryActivity.class);
        ...
        FirebaseRecyclerAdapter<Products, ProductViewHolder> adapter =
                new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Products model)
                    {
                        ...
                        holder.txtProductPhone.setText(model.getProductphone());
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        else if (id == R.id.nav_categories)
        {
         ...
         else if (id == R.id.nav_your_donations)
         {
             if(!type.equals("Admins"))
             {
                 Intent intent=new Intent(HomeActivity.this,YourDonationsActivity.class);
                 startActivity(intent);
             }
